...
*(POC: <img src=POC/Files_created.png> — confirmation that the uploaded file landed inside the web root via the junction rather than the isolated upload folder.)*
